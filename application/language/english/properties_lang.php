...
//info messages thaipoll 
$lang['info.duplicate.email'] 	= "Email Id in use. Please provide different email.";
$lang['info.empty.email'] = "Email id is required.";     
$lang['info.notsent.email'] = "Email not sent."; 
$lang['info.sent.email.'] = "Email sent successfully."; 


//user
$lang['info.invalid.userid'] = "Email id you entered is not valid"; 
$lang['info.password.update.falied'] = "update password in database failed.";
$lang['info.update.falied'] = "update in database failed.";
