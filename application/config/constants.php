...
define("DEFAULT_REGION_ID", 1); //Default region id
...
//registration (first poll)
define("REGION", "region_id");
define("PROVINCE", "province_id");
define("GENDER", "gender");
define("DOB", "dob");
define("EDUCATION", "education_id");
define("INCOME", "income_group_id");
define("INTEREST", "interest_id");
define("JOBFUNCTION", "job_function_id");
define("JOBSTATUS", "job_status_id");
define("RELATIONSHIPSTATUS", "relationship_id");
define("FAMILYSTATUS", "family_status_id");
...
define('ADD_TYPE','add_type');
define('VISIBILITY','visibility');
define('FILTERQUES','filterques');
define('SAVEPAY','savepay');
define('SKIP_LOGIC','skip_logic');
define('EDIT_SKIP_LOGIC','edit_skip_logic');
define('EDIT_QUESTION','edit_question');
define('ADD_FILTER_QUESTION','add_filter_question');
define('EDIT_FILTER_QUESTION','edit_filter_question');
