...
//              $field = "job_status";
        ...
        ?>
        <p>
            <input type="hidden" name="jobStatus_id" value="<?php echo $jobFucntionObjArr['subQuestions']['subQ_id']; ?>"/>
        ...
        <ul class="sinlist">
           ...
           foreach($jobFucntionObjArr['subQuestions']['answer'] as $id => $answer){
                ...
                ?>
                <li>
                    <input type="radio" id="radio-<?php echo $cnt; ?>" name="job_status" value="<?php echo $answer['ans_id']; ?>">
                    <label for="radio-<?php echo $cnt; ?>">&nbsp; <?php echo $answer['ans_text']; ?></label>
                </li>
            <?php } ?>
        </ul>
    ...
    <div class="quescol custinput" id="<?php echo $relationshipStatusObjArr['q_id']; ?>">
        ...
        <ul class="sinlist">
            <?php 
                ...
                ?>
                <li>
                    <input type="radio" id="radio-<?php echo $cnt; ?>" name="relationship" value="<?php echo $answer['ans_id']; ?>">
                    <label for="radio-<?php echo $cnt; ?>">&nbsp; <?php echo $answer['ans_text']; ?></label>
                </li>
            <?php } ?>
        </ul>
    ...
    <div class="quescol custinput" id="<?php echo $familyStatusObjArr['q_id']; ?>" >
        ...
        <ul class="sinlist">
           <?php 
                ...
                ?>
                <li>
                    <input type="radio" id="radio-<?php echo $cnt; ?>" name="family_status" value="<?php echo $answer['ans_id']; ?>">
                    <label for="radio-<?php echo $cnt; ?>">&nbsp; <?php echo $answer['ans_text']; ?></label>
                </li>
            <?php } ?>
        </ul>
    ...
    <div class="quescol custinput" id="<?php echo $interestObjArr['q_id']; ?>">
        ...
        <ul class="sinlist">
            <?php 
                foreach($interestObjArr['answer'] as $id => $answer){
                    $cnt++;
                ?>
                <li>
                    <input type="checkbox" id="check-<?php echo $cnt; ?>" name="interest_id" value="<?php echo $answer['ans_id']; ?>">
                    <label for="check-<?php echo $cnt; ?>">&nbsp; <?php echo $answer['ans_text']; ?></label>
                </li>
            <?php } ?>
        </ul>
    </div>
